...
<div class="text-center">
    <button class="btn btn-raised btn-secondary btn-lg" type="submit"
            name="back" onclick="history.back()">Go back a page
    </button>
</div>
<p>
<div class="text-center">
    <button class="btn btn-raised btn-primary btn-lg" type="submit"
            name="back" onclick="goHome()">Go
        homepage
    </button>
</div>
...
<script>
    function goHome() {
        ...
        first.indexOf(1);
        first = first.split("/")[1];
        console.log(window.location.origin  + '/' + first + '/');
        window.open(window.location.origin  + '/' + first + '/');
    }
</script>
</body>
</html>
